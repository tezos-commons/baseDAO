...
module Lorentz.Contracts.BaseDAO.Impl
  ( StorageC
  , contractScript
...
contractScript :: Contract Parameter Storage
contractScript = defaultContract $ contractName "Managed Ledger" $ do
