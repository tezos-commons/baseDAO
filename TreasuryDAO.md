...
**Code revision:** [5fd2897](https://github.com/tqtezos/baseDAO/tree/5fd2897616097f82bf942d969d4a813525535fb1) *(Sat Mar 27 01:46:51 2021 +0530)*
...
**Argument:** 
  ...
  + **In Michelson:** `(pair nat (pair nat (list (or (pair mutez address) (pair address (list (pair address (list (pair address (pair nat nat))))))))))`
...
Describe the transfer type of the proposal which are: token transfer type and xtz transfer type.
