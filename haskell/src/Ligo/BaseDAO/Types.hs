...
type family CustomEpToParam (v :: Variants) :: Type
type instance CustomEpToParam 'Base = ()
...
mkFullStorage
  ...
  -> "tokenAddress" :! Address
  -> FullStorage
mkFullStorage admin vp qt mcp cp gts extra mdt lvl tokenAddress = FullStorage
