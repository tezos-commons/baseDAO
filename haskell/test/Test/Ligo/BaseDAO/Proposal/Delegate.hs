...
updateDelegates originateFn getDelegateFn = do
  ...
  -- Before Delegate set
  BigMap delegates1 <- getDelegateFn (chAddress dodDao)
  ...
  BigMap delegates2 <- getDelegateFn (chAddress dodDao)
  ...
  BigMap delegates3 <- getDelegateFn (chAddress dodDao)
  ...
  BigMap delegates4 <- getDelegateFn (chAddress dodDao)
